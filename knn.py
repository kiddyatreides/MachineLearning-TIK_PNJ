...
for i in range(n_training_samples):
	neighbors = get_neighbors(learnset_data, learnset_labels, testset_data[i], 2, distance=distance)
	print("index: ", i, 
...
words = []
with open("D:/british-english.txt") as fh:
    for line in fh:
        word = line.strip()
        words.append(word)
...
#Tugas	
#ambil 10 persen dataset dari iris data training secara random
#iris data nya diambil 10% aja.
#dari 10% data tersebut tetangga nya siapa aja
#jalankan seperti tadi